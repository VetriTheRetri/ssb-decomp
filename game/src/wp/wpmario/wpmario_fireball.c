...
bool32 wpMario_Fireball_ProcMap(GObj *weapon_gobj) // Collision
{
    ...
    if (wpMap_CheckCollideAllModifyVel(weapon_gobj, MPCOLL_MASK_MAIN_ALL, wpMario_Fireball_WeaponAttributes[wp->weapon_vars.fireball.index].collide_vel, &pos) != FALSE)
    {
