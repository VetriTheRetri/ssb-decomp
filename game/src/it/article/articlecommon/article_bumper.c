...
extern ArticleStatusDesc Article_IBumper_Status[];

void func_ovl3_8017B600(GObj *article_gobj)
{
    func_ovl3_80172E74(article_gobj);
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 0);
}
...
void func_ovl3_8017B634(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 1);
}

void jtgt_ovl3_8017B678(GObj *article_gobj)
{
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 2);
}
...
void jtgt_ovl3_8017B7DC(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 3);
}
...
void func_ovl3_8017B828(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 4);
}
...
void func_ovl3_8017BD4C(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 5);
}
...
void func_ovl3_8017BEA0(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 6);
}
...
void func_ovl3_8017BF1C(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_IBumper_Status, 7);
}

extern ArticleSpawnData Article_IBumper_Data;

GObj* jtgt_ovl3_8017BF8C(GObj *spawn_gobj, Vec3f *pos, Vec3f *vel, u32 flags)
{
    GObj *article_gobj = func_ovl3_8016E174(spawn_gobj, &Article_IBumper_Data, pos, vel, flags);
