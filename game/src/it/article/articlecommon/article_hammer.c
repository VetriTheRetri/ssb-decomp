...
void func_ovl3_801761C4(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Hammer_Status, 0);
}
...
void func_ovl3_801761F8(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Hammer_Status, 1);
}
...
void jtgt_ovl3_8017623C(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Hammer_Status, 2);
}
...
{
    atCommon_UpdateArticleStatus(item_gobj, Article_Hammer_Status, 3);
...
void jtgt_ovl3_80176378(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Hammer_Status, 4);
