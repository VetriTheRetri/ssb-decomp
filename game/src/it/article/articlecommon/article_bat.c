...
extern ArticleLogicDesc Article_Bat_Status[];

void func_ovl3_80174EC4(GObj *article_gobj)
{
    func_ovl3_80172E74(article_gobj);
    func_ovl3_80172EC8(article_gobj, Article_Bat_Status, 0);
}
...
void func_ovl3_80174EF8(GObj *article_gobj)
{
    ...
    func_ovl3_80172EC8(article_gobj, Article_Bat_Status, 1);
}
...
extern ArticleStatusData Article_Bat_Data;
