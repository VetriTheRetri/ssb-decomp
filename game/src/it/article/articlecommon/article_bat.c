...
itCreateDesc itCommon_Bat_ItemDesc =
{
    ...
    itBat_AWaitFall_ProcUpdate,             // Proc Update
    itBat_AWaitFall_ProcMap,                // Proc Map
    NULL,                                   // Proc Hit
    NULL,                                   // Proc Shield
    NULL,                                   // Proc Hop
    NULL,                                   // Proc Set-Off
...
// 0x80174E30 
bool32 itBat_AWaitFall_ProcUpdate(GObj *item_gobj)
{
...
{
    func_ovl3_801735A0(item_gobj, itBat_AWaitFall_SetStatus);

    return FALSE;
}

// 0x80174E90
bool32 itBat_AWaitFall_ProcMap(GObj *item_gobj)
{
...
void itBat_GWait_SetStatus(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, itCommon_Bat_StatusDesc, itStatus_Bat_GWait);
}

// 0x80174EF8
void itBat_AWaitFall_SetStatus(GObj *item_gobj)
{
    Item_Struct *ip = itGetStruct(item_gobj);
    ...
    atCommon_UpdateArticleStatus(item_gobj, itCommon_Bat_StatusDesc, itStatus_Bat_AWaitFall);
}
...
void itBat_FHold_SetStatus(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, itCommon_Bat_StatusDesc, itStatus_Bat_FHold);
}
...
{
    atCommon_UpdateArticleStatus(item_gobj, itCommon_Bat_StatusDesc, itStatus_Bat_AThrow);
...
{
    atCommon_UpdateArticleStatus(item_gobj, itCommon_Bat_StatusDesc, itStatus_Bat_ADrop);
