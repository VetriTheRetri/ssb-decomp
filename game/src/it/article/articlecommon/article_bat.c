...
extern itStatusDesc Article_Bat_Status[];
...
{
    func_ovl3_80172558(itGetStruct(article_gobj), ATBAT_GRAVITY, ATBAT_T_VEL);
    func_ovl3_801713F4(article_gobj);
...
extern itCreateDesc Article_Bat_Data;

GObj* jtgt_ovl3_801750B8(GObj *spawn_gobj, Vec3f *pos, Vec3f *vel, u32 flags)
{
    GObj *article_gobj = itManager_CreateItem(spawn_gobj, &Article_Bat_Data, pos, vel, flags);
