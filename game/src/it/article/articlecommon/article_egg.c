...
void func_ovl3_801816E0(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Egg_Status, 0);
}
...
void func_ovl3_8018171C(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Egg_Status, 1);
}

void jtgt_ovl3_80181778(GObj *item_gobj)
{
    atCommon_UpdateArticleStatus(item_gobj, Article_Egg_Status, 2);
}
...
void jtgt_ovl3_80181854(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Egg_Status, 3);
}
...
void jtgt_ovl3_801818E8(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Egg_Status, 4);
}
...
bool32 jtgt_ovl3_80181928(GObj *item_gobj)
{
    ...
    func_ovl3_80173180(item_gobj, (ArticleHitEvent*) ((uintptr_t)*Article_Egg_Data.p_file + (intptr_t)&D_NF_00000B14) ); // Linker thing
...
GObj* jtgt_ovl3_80181998(GObj *spawn_gobj, Vec3f *pos, Vec3f *vel, u32 flags)
{
    ...
    if (item_gobj != NULL)
    {
        ...
        egg_ap->indicator_gobj = func_ovl2_80111EC0(egg_ap);
...
void func_ovl3_80181AA8(GObj *item_gobj)
{
    ...
    func_ovl3_80173180(item_gobj, (ArticleHitEvent*) ( (uintptr_t)*Article_Egg_Data.p_file + (intptr_t)&D_NF_00000098) ); // Linker thing
}

void func_ovl3_80181B5C(GObj *item_gobj)
{
    func_ovl3_80181AA8(item_gobj);
    atCommon_UpdateArticleStatus(item_gobj, Article_Egg_Status, 5);
}
