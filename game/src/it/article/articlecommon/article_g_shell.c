...
void func_ovl3_801787CC(GObj *item_gobj)
{
    ...
    if (ABSF(ap->phys_info.vel.x) < ATGSHELL_STOP_VEL_X)
    {
        ...
        atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 0);
    }
...
void func_ovl3_80178930(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 1);
}
...
void jtgt_ovl3_80178A90(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 2);
}
...
void jtgt_ovl3_80178B28(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 3);
}
...
void jtgt_ovl3_80178B60(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 4);
}
...
void func_ovl3_80178EDC(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 5);
}
...
void func_ovl3_80178FA8(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_G_Shell_Status, 6);
}
