...
void func_ovl3_801751F4(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Harisen_Status, 0);
}
...
void func_ovl3_80175228(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Harisen_Status, 1);
}
...
void jtgt_ovl3_8017526C(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Harisen_Status, 2);
}
...
{
    atCommon_UpdateArticleStatus(item_gobj, Article_Harisen_Status, 3);
...
{
    atCommon_UpdateArticleStatus(item_gobj, Article_Harisen_Status, 4);
