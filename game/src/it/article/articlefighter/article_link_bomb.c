...
void func_ovl3_80185F70(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Link_Bomb_Status, 0);
}
...
void func_ovl3_80185FD8(GObj *item_gobj)
{
    ...
    func_ovl3_80185CD4(item_gobj);
    atCommon_UpdateArticleStatus(item_gobj, &Article_Link_Bomb_Status, 1);
}
...
{
    func_ovl3_80185CE4(item_gobj);
    atCommon_UpdateArticleStatus(item_gobj, Article_Link_Bomb_Status, 2);
}
...
void jtgt_ovl3_80186224(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Link_Bomb_Status, 3);
}
...
void jtgt_ovl3_80186314(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Link_Bomb_Status, 4);
}
...
void func_ovl3_8018656C(GObj *item_gobj)
{
    ...
    atCommon_UpdateArticleStatus(item_gobj, Article_Link_Bomb_Status, 5);
}
