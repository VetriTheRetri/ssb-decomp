...
void func_ovl3_80155CF4(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Kirby_CopyNess_SpecialN, fighter_gobj->anim_frame, 1.0F, 0x96U);
...
void func_ovl3_80155D48(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Kirby_CopyNess_SpecialAirN, fighter_gobj->anim_frame, 1.0F, 0x96U);
...
{
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Kirby_CopyNess_SpecialN, 0.0F, 1.0F, 0U);
...
{
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Kirby_CopyNess_SpecialAirN, 0.0F, 1.0F, 0U);
    func_ovl2_800E0830(fighter_gobj);
    func_ovl3_80155DA4(fighter_gobj);
}
