...
void func_ovl3_80151438(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Purin_SpecialN, fighter_gobj->anim_frame, 1.0F, 0x92U);
}
...
void func_ovl3_80151478(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Purin_SpecialAirN, fighter_gobj->anim_frame, 1.0F, 0x92U);
    func_ovl2_800D8EB8(fp);
}

void jtgt_ovl3_801514C4(GObj *fighter_gobj)
{
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Purin_SpecialN, 0.0F, 1.0F, 0U);
...
{
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Purin_SpecialAirN, 0.0F, 1.0F, 0U);
    func_ovl3_80151260(fighter_gobj);
    func_ovl2_800E0830(fighter_gobj);
}
