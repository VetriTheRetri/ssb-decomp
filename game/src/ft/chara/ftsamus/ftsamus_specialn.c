...
void func_ovl3_8015D4E4(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialNStart, fighter_gobj->anim_frame, fp->joint[0]->anim_rate, 2U);
...
void func_ovl3_8015D540(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialAirNStart, fighter_gobj->anim_frame, fp->joint[0]->anim_rate, 2U);
...
void func_ovl3_8015D734(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialNLoop, 0.0F, 1.0F, 2U);
...
void func_ovl3_8015D7AC(GObj *fighter_gobj)
{
    ...
    if (fp->cmd_flags.flag0 != FALSE)
    {
        ...
        if (fp->status_vars.samus.specialn.charge_gobj != NULL)
        {
            ...
            func_ovl2_800DF09C(fp->status_vars.samus.specialn.charge_gobj, fp->coll_data.unk_0x0, &fp->coll_data);
...
void func_ovl3_8015D9B0(GObj *fighter_gobj)
{
    ...
    func_ovl2_800DEE98(fp);
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialNEnd, fighter_gobj->anim_frame, 1.0F, 2U);
...
void func_ovl3_8015DA04(GObj *fighter_gobj)
{
    ...
    func_ovl2_800DEEC8(fp);
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialAirNEnd, fighter_gobj->anim_frame, 1.0F, 2U);
    func_ovl2_800D8EB8(fp);
...
void func_ovl3_8015DA60(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialNEnd, 0.0F, 1.0F, 2U);
...
void func_ovl3_8015DAA8(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialAirNEnd, 0.0F, 1.0F, 2U);
...
void jtgt_ovl3_8015DB64(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialNStart, 0.0F, func_ovl3_8015DB14(fp), 0U);
...
void jtgt_ovl3_8015DBDC(GObj *fighter_gobj)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Samus_SpecialAirNStart, 0.0F, func_ovl3_8015DB14(fp), 0U);
    func_ovl2_800E0830(fighter_gobj);
    func_ovl3_8015DB4C(fp);
