...
#define FTPIKACHU_QUICKATTACK_HALT_ANGLE 2.3561945F		// Maximum angle of stage collision that doesn't cancel Quick Attack?
...
#define FTPIKACHU_QUICKATTACK_ANGLE_DIFF_MIN 0.7330383F	// Minimum angle difference required for subsequent zips
