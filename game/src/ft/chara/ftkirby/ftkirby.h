...
#define FTKIRBY_COPYNESS_PK_FIRE_SPAWN_JOINT 0
#define FTKIRBY_COPYNESS_PK_FIRE_SPAWN_OFF_X 240.0F
#define FTKIRBY_COPYNESS_PK_FIRE_SPAWN_OFF_Y 190.0F
#define FTKIRBY_COPYNESS_PK_FIRE_SPARK_ANGLE_AIR -0.6632251F
#define FTKIRBY_COPYNESS_PK_FIRE_SPARK_ANGLE_GROUND -0.06283185F
#define FTKIRBY_COPYNESS_PK_FIRE_SPARK_VEL_AIR 95.0F
#define FTKIRBY_COPYNESS_PK_FIRE_SPARK_VEL_GROUND 73.0F
...
typedef enum ftKirbyAction
{
    ...
    ftStatus_Kirby_ThrowF_Fall,
    ftStatus_Kirby_ThrowF_Landing,
