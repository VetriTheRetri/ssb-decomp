...
bool32 func_ovl3_80143808(GObj *fighter_gobj)
{
    ...
    if ((fp->status_vars.common.fallspecial.is_allow_pass == FALSE) || !(fp->coll_data.clip_flag & 0x4000) || (fp->input.stick_range.y >= FTCOMMON_FALLSPECIAL_PASS_STICK_RANGE_MIN))
    {
        return TRUE;
    }
    else return FALSE;
...
void func_ovl3_801438F0(GObj *fighter_gobj, f32 drift, bool32 unk1, bool32 is_fall_accelerate, bool32 is_goto_landing, f32 landing_lag, bool32 is_allow_interrupt)
{
    ...
    func_ovl2_800E6F24(fighter_gobj, ftStatus_Common_FallSpecial, 0.0F, 1.0F, 8U);
