...
glabel func_ovl36_8018D614
  ...
  /* 166CFC 8018D6CC 3C15800A */       lui $s5, %hi(gMatchData)
  /* 166D00 8018D6D0 26B550E8 */     addiu $s5, $s5, %lo(gMatchData)
  ...
  /* 166D5C 8018D72C 8EAB0000 */        lw $t3, ($s5) # gMatchData + 0
  ...
  /* 166D88 8018D758 8EA20000 */        lw $v0, ($s5) # gMatchData + 0
...
glabel func_ovl36_8018DE64
  ...
  /* 1674A4 8018DE74 3C02800A */       lui $v0, %hi(gMatchData)
  /* 1674A8 8018DE78 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 1674AC 8018DE7C 244250E8 */     addiu $v0, $v0, %lo(gMatchData)
  ...
  /* 1674F0 8018DEC0 AC430000 */        sw $v1, ($v0) # gMatchData + 0
