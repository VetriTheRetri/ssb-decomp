...
glabel func_ovl36_8018D40C
  ...
  /* 166B50 8018D520 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl36_8018D614
  ...
  /* 166CFC 8018D6CC 3C15800A */       lui $s5, %hi(Match_Info)
  /* 166D00 8018D6D0 26B550E8 */     addiu $s5, $s5, %lo(Match_Info)
  ...
  /* 166D5C 8018D72C 8EAB0000 */        lw $t3, ($s5) # Match_Info + 0
  ...
  /* 166D88 8018D758 8EA20000 */        lw $v0, ($s5) # Match_Info + 0
...
glabel func_ovl36_8018DA60
  ...
  /* 167150 8018DB20 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl36_8018DBFC
  ...
  /* 167304 8018DCD4 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl36_8018DD9C
  ...
  /* 1673FC 8018DDCC 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 167400 8018DDD0 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 167404 8018DDD4 90580000 */       lbu $t8, ($v0) # Scene_Info + 0
  /* 167408 8018DDD8 A0590000 */        sb $t9, ($v0) # Scene_Info + 0
  /* 16740C 8018DDDC 0C00171D */       jal func_80005C74
  /* 167410 8018DDE0 A0580001 */        sb $t8, 1($v0) # Scene_Info + 1
  .L8018DDE4:
  ...
  /* 16742C 8018DDFC 0C0026A1 */       jal gOMObj_EjectGObjCommon
  ...
  /* 167460 8018DE30 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 167464 8018DE34 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 167468 8018DE38 90480000 */       lbu $t0, ($v0) # Scene_Info + 0
  /* 16746C 8018DE3C A0490000 */        sb $t1, ($v0) # Scene_Info + 0
  /* 167470 8018DE40 0C00171D */       jal func_80005C74
  /* 167474 8018DE44 A0480001 */        sb $t0, 1($v0) # Scene_Info + 1
  .L8018DE48:
...
glabel func_ovl36_8018DE64
  ...
  /* 1674A4 8018DE74 3C02800A */       lui $v0, %hi(Match_Info)
  /* 1674A8 8018DE78 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 1674AC 8018DE7C 244250E8 */     addiu $v0, $v0, %lo(Match_Info)
  ...
  /* 1674F0 8018DEC0 AC430000 */        sw $v1, ($v0) # Match_Info + 0
