...
glabel func_ovl38_8018D40C
  ...
  /* 168D90 8018D520 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl38_8018D614
  ...
  /* 168FA8 8018D738 3C15800A */       lui $s5, %hi(Match_Info)
  /* 168FAC 8018D73C 26B550E8 */     addiu $s5, $s5, %lo(Match_Info)
  ...
  /* 169008 8018D798 8EAD0000 */        lw $t5, ($s5) # Match_Info + 0
  ...
  /* 169034 8018D7C4 8EA20000 */        lw $v0, ($s5) # Match_Info + 0
...
glabel func_ovl38_8018DAC8
  ...
  /* 1693FC 8018DB8C 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl38_8018DC68
  ...
  /* 1695B0 8018DD40 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl38_8018DE08
  ...
  /* 1696A8 8018DE38 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 1696AC 8018DE3C 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 1696B0 8018DE40 90580000 */       lbu $t8, ($v0) # Scene_Info + 0
  /* 1696B4 8018DE44 A0590000 */        sb $t9, ($v0) # Scene_Info + 0
  /* 1696B8 8018DE48 0C00171D */       jal func_80005C74
  /* 1696BC 8018DE4C A0580001 */        sb $t8, 1($v0) # Scene_Info + 1
  .L8018DE50:
  ...
  /* 1696D8 8018DE68 0C0026A1 */       jal gOMObj_EjectGObjCommon
  ...
  /* 16970C 8018DE9C 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 169710 8018DEA0 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 169714 8018DEA4 90480000 */       lbu $t0, ($v0) # Scene_Info + 0
  /* 169718 8018DEA8 A0490000 */        sb $t1, ($v0) # Scene_Info + 0
  /* 16971C 8018DEAC 0C00171D */       jal func_80005C74
  /* 169720 8018DEB0 A0480001 */        sb $t0, 1($v0) # Scene_Info + 1
  .L8018DEB4:
...
glabel func_ovl38_8018DED0
  ...
  /* 169750 8018DEE0 3C02800A */       lui $v0, %hi(Match_Info)
  /* 169754 8018DEE4 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 169758 8018DEE8 244250E8 */     addiu $v0, $v0, %lo(Match_Info)
  ...
  /* 1697A0 8018DF30 AC430000 */        sw $v1, ($v0) # Match_Info + 0
