...
glabel func_ovl38_8018D614
  ...
  /* 168FA8 8018D738 3C15800A */       lui $s5, %hi(gMatchData)
  /* 168FAC 8018D73C 26B550E8 */     addiu $s5, $s5, %lo(gMatchData)
  ...
  /* 169008 8018D798 8EAD0000 */        lw $t5, ($s5) # gMatchData + 0
  ...
  /* 169034 8018D7C4 8EA20000 */        lw $v0, ($s5) # gMatchData + 0
...
glabel func_ovl38_8018DED0
  ...
  /* 169750 8018DEE0 3C02800A */       lui $v0, %hi(gMatchData)
  /* 169754 8018DEE4 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 169758 8018DEE8 244250E8 */     addiu $v0, $v0, %lo(gMatchData)
  ...
  /* 1697A0 8018DF30 AC430000 */        sw $v1, ($v0) # gMatchData + 0
