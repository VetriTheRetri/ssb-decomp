...
glabel func_ovl47_80131FC8
  ...
  /* 171838 80132018 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl47_801320C0
  ...
  /* 1719DC 801321BC 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl47_8013242C
  ...
  /* 171D34 80132514 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl47_801325DC
  ...
  /* 171E74 80132654 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 171E78 80132658 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 171E7C 8013265C 90480000 */       lbu $t0, ($v0) # Scene_Info + 0
  /* 171E80 80132660 A0490000 */        sb $t1, ($v0) # Scene_Info + 0
  /* 171E84 80132664 0C00171D */       jal func_80005C74
  /* 171E88 80132668 A0480001 */        sb $t0, 1($v0) # Scene_Info + 1
  .L8013266C:
  /* 171E8C 8013266C 3C0A8013 */       lui $t2, %hi(D_ovl47_801329D0)
  /* 171E90 80132670 8D4A29D0 */        lw $t2, %lo(D_ovl47_801329D0)($t2)
  /* 171E94 80132674 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 171E98 80132678 24010140 */     addiu $at, $zero, 0x140
  /* 171E9C 8013267C 15410006 */       bne $t2, $at, .L80132698
  /* 171EA0 80132680 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 171EA4 80132684 904B0000 */       lbu $t3, ($v0) # Scene_Info + 0
  /* 171EA8 80132688 240C002B */     addiu $t4, $zero, 0x2b
  /* 171EAC 8013268C A04C0000 */        sb $t4, ($v0) # Scene_Info + 0
  /* 171EB0 80132690 0C00171D */       jal func_80005C74
  /* 171EB4 80132694 A04B0001 */        sb $t3, 1($v0) # Scene_Info + 1
  .L80132698:
