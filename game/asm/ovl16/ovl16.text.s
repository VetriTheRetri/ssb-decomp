...
glabel func_ovl16_800D655C
  ...
  /* 18D118 800D6578 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 18D11C 800D657C 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 18D120 800D6580 904F0000 */       lbu $t7, ($v0) # Scene_Info + 0
  /* 18D124 800D6584 24180001 */     addiu $t8, $zero, 1
  /* 18D128 800D6588 A0580000 */        sb $t8, ($v0) # Scene_Info + 0
  /* 18D12C 800D658C 0C00171D */       jal func_80005C74
  /* 18D130 800D6590 A04F0001 */        sb $t7, 1($v0) # Scene_Info + 1
