...
glabel func_ovl31_80131B90
  ...
  /* 150D38 80131B98 3C04800A */       lui $a0, %hi(Save_Info)
  /* 150D3C 80131B9C 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
  ...
  /* 150D4C 80131BAC 948E05E0 */       lhu $t6, 0x5e0($a0) # Save_Info + 1504
  /* 150D50 80131BB0 949805DC */       lhu $t8, 0x5dc($a0) # Save_Info + 1500
  /* 150D54 80131BB4 908205DE */       lbu $v0, 0x5de($a0) # Save_Info + 1502
  ...
  /* 150D90 80131BF0 A48F05E0 */        sh $t7, 0x5e0($a0) # Save_Info + 1504
  /* 150D94 80131BF4 10200003 */      beqz $at, .L80131C04
  /* 150D98 80131BF8 A48A05DC */        sh $t2, 0x5dc($a0) # Save_Info + 1500
  /* 150D9C 80131BFC 244B0001 */     addiu $t3, $v0, 1
  /* 150DA0 80131C00 A08B05DE */        sb $t3, 0x5de($a0) # Save_Info + 1502
  .L80131C04:
  ...
  /* 150EA8 80131D08 3C04800A */       lui $a0, %hi(Save_Info)
  /* 150EAC 80131D0C 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
...
glabel func_ovl31_80132B20
  ...
  /* 151EC4 80132D24 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl31_80136C2C
  ...
  /* 155DDC 80136C3C 3C0A800A */       lui $t2, %hi(Scene_Info)
  /* 155DE0 80136C40 254A4AD0 */     addiu $t2, $t2, %lo(Scene_Info)
  ...
  /* 155E3C 80136C9C 91590010 */       lbu $t9, 0x10($t2) # Scene_Info + 16
...
glabel func_ovl31_80136D28
  ...
  /* 155FA0 80136E00 3C07800A */       lui $a3, %hi(Scene_Info)
  /* 155FA4 80136E04 24E74AD0 */     addiu $a3, $a3, %lo(Scene_Info)
  ...
  /* 155FBC 80136E1C 90EE0010 */       lbu $t6, 0x10($a3) # Scene_Info + 16
  ...
  /* 156040 80136EA0 90EE0010 */       lbu $t6, 0x10($a3) # Scene_Info + 16
  ...
  /* 156080 80136EE0 90EB0010 */       lbu $t3, 0x10($a3) # Scene_Info + 16
  ...
  /* 1560C0 80136F20 90F80010 */       lbu $t8, 0x10($a3) # Scene_Info + 16
  ...
  /* 156100 80136F60 90EC0010 */       lbu $t4, 0x10($a3) # Scene_Info + 16
...
glabel func_ovl31_801371B8
  ...
  /* 156418 80137278 3C16800A */       lui $s6, %hi(Scene_Info)
  /* 15641C 8013727C 26D64AD0 */     addiu $s6, $s6, %lo(Scene_Info)
  ...
  /* 156430 80137290 92CB0010 */       lbu $t3, 0x10($s6) # Scene_Info + 16
...
glabel func_ovl31_80137698
  ...
  .L80137760:
  /* 156900 80137760 3C0C800A */       lui $t4, %hi((Scene_Info + 0x12))
  /* 156904 80137764 918C4AE2 */       lbu $t4, %lo((Scene_Info + 0x12))($t4)
...
glabel func_ovl31_80137854
  ...
  /* 156A20 80137880 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl31_80137938
  ...
  /* 156B04 80137964 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl31_801388AC
  ...
  /* 157BB8 80138A18 3C03800A */       lui $v1, %hi(Save_Info)
  /* 157BBC 80138A1C 246344E0 */     addiu $v1, $v1, %lo(Save_Info)
  /* 157BC0 80138A20 90620457 */       lbu $v0, 0x457($v1) # Save_Info + 1111
  ...
  /* 157BD4 80138A34 907805DE */       lbu $t8, 0x5de($v1) # Save_Info + 1502
  ...
  /* 157BE4 80138A44 3C01800A */       lui $at, %hi((Scene_Info + 0x2))
  /* 157BE8 80138A48 A0394AD2 */        sb $t9, %lo((Scene_Info + 0x2))($at)
  /* 157BEC 80138A4C 24060001 */     addiu $a2, $zero, 1
  .L80138A50:
  /* 157BF0 80138A50 15000031 */      bnez $t0, .L80138B18
  /* 157BF4 80138A54 00000000 */       nop 
  /* 157BF8 80138A58 946905DC */       lhu $t1, 0x5dc($v1) # Save_Info + 1500
  ...
  /* 157C10 80138A70 3C04800A */       lui $a0, %hi(Save_Info)
  /* 157C14 80138A74 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
  /* 157C18 80138A78 2405000C */     addiu $a1, $zero, 0xc
  .L80138A7C:
  /* 157C1C 80138A7C 908B0479 */       lbu $t3, 0x479($a0) # Save_Info + 1145
  ...
  .L80138A98:
  /* 157C38 80138A98 908E0499 */       lbu $t6, 0x499($a0) # Save_Info + 1177
  ...
  .L80138AB4:
  /* 157C54 80138AB4 908804B9 */       lbu $t0, 0x4b9($a0) # Save_Info + 1209
  ...
  .L80138AD0:
  /* 157C70 80138AD0 908C04D9 */       lbu $t4, 0x4d9($a0) # Save_Info + 1241
  ...
  /* 157CA0 80138B00 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 157CA4 80138B04 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  ...
  .L80138B18:
  /* 157CB8 80138B18 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 157CBC 80138B1C 10C00006 */      beqz $a2, .L80138B38
  /* 157CC0 80138B20 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 157CC4 80138B24 904A0000 */       lbu $t2, ($v0) # Scene_Info + 0
  /* 157CC8 80138B28 2409000C */     addiu $t1, $zero, 0xc
  /* 157CCC 80138B2C A0490000 */        sb $t1, ($v0) # Scene_Info + 0
  /* 157CD0 80138B30 10000005 */         b .L80138B48
  /* 157CD4 80138B34 A04A0001 */        sb $t2, 1($v0) # Scene_Info + 1
  .L80138B38:
  /* 157CD8 80138B38 904B0000 */       lbu $t3, ($v0) # Scene_Info + 0
  /* 157CDC 80138B3C 240C0010 */     addiu $t4, $zero, 0x10
  /* 157CE0 80138B40 A04C0000 */        sb $t4, ($v0) # Scene_Info + 0
  /* 157CE4 80138B44 A04B0001 */        sb $t3, 1($v0) # Scene_Info + 1
  .L80138B48:
