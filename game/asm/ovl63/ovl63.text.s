...
glabel func_ovl63_8018D14C
  ...
  /* 18A768 8018D158 3C03800A */       lui $v1, %hi(gMatchData)
  /* 18A76C 8018D15C 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 18A770 8018D160 246350E8 */     addiu $v1, $v1, %lo(gMatchData)
  ...
  /* 18A7BC 8018D1AC AC620000 */        sw $v0, ($v1) # gMatchData + 0
...
glabel func_ovl63_8018D1D4
  ...
  .L8018D224:
  /* 18A834 8018D224 3C08800A */       lui $t0, %hi(gMatchData)
  /* 18A838 8018D228 8D0850E8 */        lw $t0, %lo(gMatchData)($t0)
...
glabel func_ovl63_8018E1A0
  ...
  /* 18B874 8018E264 3C13800A */       lui $s3, %hi(gMatchData)
  /* 18B878 8018E268 267350E8 */     addiu $s3, $s3, %lo(gMatchData)
  ...
  /* 18B8CC 8018E2BC 8E690000 */        lw $t1, ($s3) # gMatchData + 0
  ...
  /* 18B908 8018E2F8 8E6E0000 */        lw $t6, ($s3) # gMatchData + 0
  ...
  .L8018E344:
  /* 18B954 8018E344 8E630000 */        lw $v1, ($s3) # gMatchData + 0
  ...
  /* 18B9D0 8018E3C0 8E6B0000 */        lw $t3, ($s3) # gMatchData + 0
  ...
  /* 18B9E4 8018E3D4 8E6D0000 */        lw $t5, ($s3) # gMatchData + 0
