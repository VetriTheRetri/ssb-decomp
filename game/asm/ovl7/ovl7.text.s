...
glabel func_ovl7_8018D0E8
  /* 113908 8018D0E8 3C04800A */       lui $a0, %hi((Scene_Info + 0x13))
  /* 11390C 8018D0EC 90844AE3 */       lbu $a0, %lo((Scene_Info + 0x13))($a0)
  ...
  /* 113940 8018D120 3C19800A */       lui $t9, %hi(Match_Info)
  /* 113944 8018D124 8F3950E8 */        lw $t9, %lo(Match_Info)($t9)
  ...
  /* 11398C 8018D16C 3C0C800A */       lui $t4, %hi(Match_Info)
  /* 113990 8018D170 8D8C50E8 */        lw $t4, %lo(Match_Info)($t4)
  ...
  /* 1139AC 8018D18C 3C0F800A */       lui $t7, %hi(Match_Info)
  /* 1139B0 8018D190 8DEF50E8 */        lw $t7, %lo(Match_Info)($t7)
  ...
  /* 1139D4 8018D1B4 3C0A800A */       lui $t2, %hi(Match_Info)
  /* 1139D8 8018D1B8 8D4A50E8 */        lw $t2, %lo(Match_Info)($t2)
...
glabel func_ovl7_8018D1F0
  /* 113A10 8018D1F0 3C02800A */       lui $v0, %hi((Scene_Info + 0x13))
  /* 113A14 8018D1F4 90424AE3 */       lbu $v0, %lo((Scene_Info + 0x13))($v0)
  ...
  /* 113A5C 8018D23C 3C02800A */       lui $v0, %hi(Match_Info)
  /* 113A60 8018D240 244250E8 */     addiu $v0, $v0, %lo(Match_Info)
  /* 113A64 8018D244 8C490000 */        lw $t1, ($v0) # Match_Info + 0
  ...
  /* 113A78 8018D258 8C4A0000 */        lw $t2, ($v0) # Match_Info + 0
  ...
  /* 113AA0 8018D280 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 113AA4 8018D284 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
...
glabel func_ovl7_8018D2F0
  /* 113B10 8018D2F0 3C03800A */       lui $v1, %hi((Scene_Info + 0x13))
  /* 113B14 8018D2F4 90634AE3 */       lbu $v1, %lo((Scene_Info + 0x13))($v1)
...
glabel func_ovl7_8018D4D0
  ...
  /* 113D78 8018D558 3C0E800A */       lui $t6, %hi((Scene_Info + 0x13))
  /* 113D7C 8018D55C 14400043 */      bnez $v0, .L8018D66C
  /* 113D80 8018D560 244AFFFF */     addiu $t2, $v0, -1
  /* 113D84 8018D564 91CE4AE3 */       lbu $t6, %lo((Scene_Info + 0x13))($t6)
  ...
  /* 113DC8 8018D5A8 3C09800A */       lui $t1, %hi(Match_Info)
  /* 113DCC 8018D5AC 3C0A800A */       lui $t2, %hi((Scene_Info + 0x13))
  /* 113DD0 8018D5B0 914A4AE3 */       lbu $t2, %lo((Scene_Info + 0x13))($t2)
  ...
  /* 113DE8 8018D5C8 8D2950E8 */        lw $t1, %lo(Match_Info)($t1)
  ...
  /* 113FD8 8018D7B8 3C0E800A */       lui $t6, %hi((Scene_Info + 0x13))
  /* 113FDC 8018D7BC 91CE4AE3 */       lbu $t6, %lo((Scene_Info + 0x13))($t6)
  ...
  /* 114050 8018D830 3C0E800A */       lui $t6, %hi((Scene_Info + 0x13))
  /* 114054 8018D834 91CE4AE3 */       lbu $t6, %lo((Scene_Info + 0x13))($t6)
...
glabel func_ovl7_8018D9F0
  /* 114210 8018D9F0 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 114214 8018D9F4 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
...
glabel func_ovl7_8018DA98
  ...
  /* 1142C4 8018DAA4 3C06800A */       lui $a2, %hi(Match_Info)
  /* 1142C8 8018DAA8 3C07800A */       lui $a3, %hi(Scene_Info)
  /* 1142CC 8018DAAC 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 1142D0 8018DAB0 24E74AD0 */     addiu $a3, $a3, %lo(Scene_Info)
  /* 1142D4 8018DAB4 24C650E8 */     addiu $a2, $a2, %lo(Match_Info)
  ...
  /* 114318 8018DAF8 90EC000F */       lbu $t4, 0xf($a3) # Scene_Info + 15
  /* 11431C 8018DAFC ACC50000 */        sw $a1, ($a2) # Match_Info + 0
  ...
  /* 11441C 8018DBFC 90ED0013 */       lbu $t5, 0x13($a3) # Scene_Info + 19
  ...
  /* 114440 8018DC20 8CCF0000 */        lw $t7, ($a2) # Match_Info + 0
  ...
  /* 114458 8018DC38 8CD80000 */        lw $t8, ($a2) # Match_Info + 0
  ...
  /* 11446C 8018DC4C 8CCB0000 */        lw $t3, ($a2) # Match_Info + 0
  /* 114470 8018DC50 90EA003D */       lbu $t2, 0x3d($a3) # Scene_Info + 61
  ...
  /* 114480 8018DC60 8CCD0000 */        lw $t5, ($a2) # Match_Info + 0
  /* 114484 8018DC64 90EE003E */       lbu $t6, 0x3e($a3) # Scene_Info + 62
  ...
  /* 114494 8018DC74 8CD80000 */        lw $t8, ($a2) # Match_Info + 0
  /* 114498 8018DC78 03036021 */      addu $t4, $t8, $v1
  /* 11449C 8018DC7C A1990020 */        sb $t9, 0x20($t4)
  /* 1144A0 8018DC80 8CCB0000 */        lw $t3, ($a2) # Match_Info + 0
...
glabel func_ovl7_8018DD0C
  ...
  /* 1145D0 8018DDB0 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 1145D4 8018DDB4 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
  ...
  /* 1145E8 8018DDC8 3C198013 */       lui $t9, %hi(Ground_Info)
  ...
  /* 1145F8 8018DDD8 8F391300 */        lw $t9, %lo(Ground_Info)($t9)
  ...
  /* 11462C 8018DE0C 3C0A800A */       lui $t2, %hi(Match_Info)
  /* 114630 8018DE10 8D4A50E8 */        lw $t2, %lo(Match_Info)($t2)
  ...
  /* 114640 8018DE20 3C198013 */       lui $t9, %hi(Ground_Info)
  /* 114644 8018DE24 8F391300 */        lw $t9, %lo(Ground_Info)($t9)
...
glabel func_ovl7_8018DE60
  /* 114680 8018DE60 3C0F800A */       lui $t7, %hi(Match_Info)
  /* 114684 8018DE64 8DEF50E8 */        lw $t7, %lo(Match_Info)($t7)
  ...
  /* 1146AC 8018DE8C 3C0E8013 */       lui $t6, %hi(Ground_Info)
  ...
  /* 1146C8 8018DEA8 8DCE1300 */        lw $t6, %lo(Ground_Info)($t6)
...
glabel func_ovl7_8018E138
  ...
  /* 114964 8018E144 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 114968 8018E148 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
...
glabel func_ovl7_8018E310
  ...
  /* 114BA8 8018E388 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl7_8018E56C
  ...
  /* 114D98 8018E578 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 114D9C 8018E57C 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
...
glabel func_ovl7_8018E62C
  ...
  /* 114EC4 8018E6A4 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl7_8018E9AC
  /* 1151CC 8018E9AC 3C0F800A */       lui $t7, %hi((Scene_Info + 0x13))
  /* 1151D0 8018E9B0 91EF4AE3 */       lbu $t7, %lo((Scene_Info + 0x13))($t7)
  /* 1151D4 8018E9B4 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 1151D8 8018E9B8 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
...
glabel func_ovl7_8018F4EC
  ...
  /* 115DD4 8018F5B4 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl7_801901A0
  ...
  .L801901D0:
  /* 1169F0 801901D0 3C0F800A */       lui $t7, %hi(Match_Info)
  /* 1169F4 801901D4 8DEF50E8 */        lw $t7, %lo(Match_Info)($t7)
...
glabel func_ovl7_801901F4
  ...
  /* 116A20 80190200 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 116A24 80190204 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
...
glabel func_ovl7_80190260
  ...
  /* 116B54 80190334 3C13800A */       lui $s3, %hi(Match_Info)
  /* 116B58 80190338 267350E8 */     addiu $s3, $s3, %lo(Match_Info)
  ...
  /* 116BAC 8019038C 8E6A0000 */        lw $t2, ($s3) # Match_Info + 0
  ...
  /* 116BD8 801903B8 8E6E0000 */        lw $t6, ($s3) # Match_Info + 0
  ...
  .L80190404:
  /* 116C24 80190404 8E630000 */        lw $v1, ($s3) # Match_Info + 0
...
glabel training_mode_battle_entry
  ...
  /* 116EC4 801906A4 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 116EC8 801906A8 8FBF001C */        lw $ra, 0x1c($sp)
  /* 116ECC 801906AC 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 116ED0 801906B0 904B0000 */       lbu $t3, ($v0) # Scene_Info + 0
  /* 116ED4 801906B4 240C0012 */     addiu $t4, $zero, 0x12
  /* 116ED8 801906B8 8FB00014 */        lw $s0, 0x14($sp)
  /* 116EDC 801906BC 8FB10018 */        lw $s1, 0x18($sp)
  /* 116EE0 801906C0 A04C0000 */        sb $t4, ($v0) # Scene_Info + 0
  /* 116EE4 801906C4 27BD0020 */     addiu $sp, $sp, 0x20
  /* 116EE8 801906C8 03E00008 */        jr $ra
  /* 116EEC 801906CC A04B0001 */        sb $t3, 1($v0) # Scene_Info + 1
