...
glabel func_ovl7_8018D0E8
  ...
  /* 113940 8018D120 3C19800A */       lui $t9, %hi(gpMatchData)
  /* 113944 8018D124 8F3950E8 */        lw $t9, %lo(gpMatchData)($t9)
  ...
  /* 11398C 8018D16C 3C0C800A */       lui $t4, %hi(gpMatchData)
  /* 113990 8018D170 8D8C50E8 */        lw $t4, %lo(gpMatchData)($t4)
  ...
  /* 1139AC 8018D18C 3C0F800A */       lui $t7, %hi(gpMatchData)
  /* 1139B0 8018D190 8DEF50E8 */        lw $t7, %lo(gpMatchData)($t7)
  ...
  /* 1139D4 8018D1B4 3C0A800A */       lui $t2, %hi(gpMatchData)
  /* 1139D8 8018D1B8 8D4A50E8 */        lw $t2, %lo(gpMatchData)($t2)
...
glabel func_ovl7_8018D1F0
  ...
  /* 113A5C 8018D23C 3C02800A */       lui $v0, %hi(gpMatchData)
  /* 113A60 8018D240 244250E8 */     addiu $v0, $v0, %lo(gpMatchData)
  /* 113A64 8018D244 8C490000 */        lw $t1, ($v0) # gpMatchData + 0
  ...
  /* 113A78 8018D258 8C4A0000 */        lw $t2, ($v0) # gpMatchData + 0
  ...
  /* 113AA0 8018D280 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 113AA4 8018D284 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
...
glabel func_ovl7_8018D4D0
  ...
  /* 113DC8 8018D5A8 3C09800A */       lui $t1, %hi(gpMatchData)
  ...
  /* 113DE8 8018D5C8 8D2950E8 */        lw $t1, %lo(gpMatchData)($t1)
...
glabel func_ovl7_8018D9F0
  /* 114210 8018D9F0 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 114214 8018D9F4 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
...
glabel func_ovl7_8018DA98
  ...
  /* 1142C4 8018DAA4 3C06800A */       lui $a2, %hi(gpMatchData)
  ...
  /* 1142D4 8018DAB4 24C650E8 */     addiu $a2, $a2, %lo(gpMatchData)
  ...
  /* 11431C 8018DAFC ACC50000 */        sw $a1, ($a2) # gpMatchData + 0
  ...
  /* 114350 8018DB30 8CCD0000 */        lw $t5, ($a2) # gpMatchData + 0
  /* 114354 8018DB34 8CCB0000 */        lw $t3, ($a2) # gpMatchData + 0
  /* 114358 8018DB38 01646021 */      addu $t4, $t3, $a0
  /* 11435C 8018DB3C A1800022 */        sb $zero, 0x22($t4)
  /* 114360 8018DB40 8CC90000 */        lw $t1, ($a2) # gpMatchData + 0
  ...
  /* 114370 8018DB50 8CCF0000 */        lw $t7, ($a2) # gpMatchData + 0
  ...
  /* 1143B4 8018DB94 8CC90000 */        lw $t1, ($a2) # gpMatchData + 0
  /* 1143B8 8018DB98 8CD80000 */        lw $t8, ($a2) # gpMatchData + 0
  /* 1143BC 8018DB9C 03045021 */      addu $t2, $t8, $a0
  /* 1143C0 8018DBA0 A1400096 */        sb $zero, 0x96($t2)
  /* 1143C4 8018DBA4 8CCC0000 */        lw $t4, ($a2) # gpMatchData + 0
  ...
  /* 1143D8 8018DBB8 8CCE0000 */        lw $t6, ($a2) # gpMatchData + 0
  ...
  /* 114440 8018DC20 8CCF0000 */        lw $t7, ($a2) # gpMatchData + 0
  ...
  /* 114458 8018DC38 8CD80000 */        lw $t8, ($a2) # gpMatchData + 0
  ...
  /* 11446C 8018DC4C 8CCB0000 */        lw $t3, ($a2) # gpMatchData + 0
  ...
  /* 114480 8018DC60 8CCD0000 */        lw $t5, ($a2) # gpMatchData + 0
  ...
  /* 114494 8018DC74 8CD80000 */        lw $t8, ($a2) # gpMatchData + 0
  /* 114498 8018DC78 03036021 */      addu $t4, $t8, $v1
  /* 11449C 8018DC7C A1990020 */        sb $t9, 0x20($t4)
  /* 1144A0 8018DC80 8CCB0000 */        lw $t3, ($a2) # gpMatchData + 0
...
glabel func_ovl7_8018DD0C
  ...
  /* 1145D0 8018DDB0 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 1145D4 8018DDB4 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
  ...
  /* 11462C 8018DE0C 3C0A800A */       lui $t2, %hi(gpMatchData)
  /* 114630 8018DE10 8D4A50E8 */        lw $t2, %lo(gpMatchData)($t2)
...
glabel func_ovl7_8018DE60
  /* 114680 8018DE60 3C0F800A */       lui $t7, %hi(gpMatchData)
  /* 114684 8018DE64 8DEF50E8 */        lw $t7, %lo(gpMatchData)($t7)
...
glabel func_ovl7_8018E138
  ...
  /* 114964 8018E144 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 114968 8018E148 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
...
glabel func_ovl7_8018E56C
  ...
  /* 114D98 8018E578 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 114D9C 8018E57C 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
...
glabel func_ovl7_8018E9AC
  ...
  /* 1151D4 8018E9B4 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 1151D8 8018E9B8 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
...
glabel func_ovl7_801901A0
  ...
  .L801901D0:
  /* 1169F0 801901D0 3C0F800A */       lui $t7, %hi(gpMatchData)
  /* 1169F4 801901D4 8DEF50E8 */        lw $t7, %lo(gpMatchData)($t7)
...
glabel func_ovl7_801901F4
  ...
  /* 116A20 80190200 3C0E800A */       lui $t6, %hi(gpMatchData)
  /* 116A24 80190204 8DCE50E8 */        lw $t6, %lo(gpMatchData)($t6)
...
glabel func_ovl7_80190260
  ...
  /* 116B54 80190334 3C13800A */       lui $s3, %hi(gpMatchData)
  /* 116B58 80190338 267350E8 */     addiu $s3, $s3, %lo(gpMatchData)
  ...
  /* 116BAC 8019038C 8E6A0000 */        lw $t2, ($s3) # gpMatchData + 0
  ...
  /* 116BD8 801903B8 8E6E0000 */        lw $t6, ($s3) # gpMatchData + 0
  ...
  .L80190404:
  /* 116C24 80190404 8E630000 */        lw $v1, ($s3) # gpMatchData + 0
