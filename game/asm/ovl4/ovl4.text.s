...
glabel func_ovl4_8018D0E0
  ...
  /* 10A014 8018D124 3C15800A */       lui $s5, %hi(gpMatchData)
  /* 10A018 8018D128 26B550E8 */     addiu $s5, $s5, %lo(gpMatchData)
  ...
  /* 10A03C 8018D14C 8EA20000 */        lw $v0, ($s5) # gpMatchData + 0
...
glabel func_ovl4_8018D228
  ...
  /* 10A290 8018D3A0 3C12800A */       lui $s2, %hi(gpMatchData)
  /* 10A294 8018D3A4 265250E8 */     addiu $s2, $s2, %lo(gpMatchData)
  ...
  /* 10A2E8 8018D3F8 8E480000 */        lw $t0, ($s2) # gpMatchData + 0
  ...
  /* 10A314 8018D424 8E4C0000 */        lw $t4, ($s2) # gpMatchData + 0
  ...
  /* 10A338 8018D448 8E450000 */        lw $a1, ($s2) # gpMatchData + 0
...
glabel func_ovl4_8018D5E0
  ...
  /* 10A4D4 8018D5E4 3C0D800A */       lui $t5, %hi(gpMatchData)
  /* 10A4D8 8018D5E8 8DAD50E8 */        lw $t5, %lo(gpMatchData)($t5)
...
glabel func_ovl4_8018DE20
  ...
  /* 10ADDC 8018DEEC 3C12800A */       lui $s2, %hi(gpMatchData)
  /* 10ADE0 8018DEF0 265250E8 */     addiu $s2, $s2, %lo(gpMatchData)
  ...
  /* 10AE34 8018DF44 8E4A0000 */        lw $t2, ($s2) # gpMatchData + 0
  ...
  /* 10AE60 8018DF70 8E4E0000 */        lw $t6, ($s2) # gpMatchData + 0
  ...
  /* 10AE84 8018DF94 8E430000 */        lw $v1, ($s2) # gpMatchData + 0
  ...
  /* 10AF2C 8018E03C 8E4C0000 */        lw $t4, ($s2) # gpMatchData + 0
...
glabel vs_battle_entry
  /* 10B080 8018E190 3C02800A */       lui $v0, %hi(gpMatchData)
  /* 10B084 8018E194 3C0E800A */       lui $t6, %hi(D_800A4D08)
  /* 10B088 8018E198 244250E8 */     addiu $v0, $v0, %lo(gpMatchData)
  ...
  /* 10B098 8018E1A8 AC4E0000 */        sw $t6, ($v0) # gpMatchData + 0
  ...
  /* 10B0AC 8018E1BC 8C480000 */        lw $t0, ($v0) # gpMatchData + 0
  ...
  /* 10B0D4 8018E1E4 8C4B0000 */        lw $t3, ($v0) # gpMatchData + 0
  ...
  /* 10B180 8018E290 3C02800A */       lui $v0, %hi(gpMatchData)
  /* 10B184 8018E294 3C09800A */       lui $t1, %hi(D_800A4EF8)
  /* 10B188 8018E298 244250E8 */     addiu $v0, $v0, %lo(gpMatchData)
  /* 10B18C 8018E29C 25294EF8 */     addiu $t1, $t1, %lo(D_800A4EF8)
  /* 10B190 8018E2A0 AC490000 */        sw $t1, ($v0) # gpMatchData + 0
