...
glabel func_ovl41_8018D61C
  ...
  /* 16C34C 8018D6FC 3C15800A */       lui $s5, %hi(gMatchData)
  /* 16C350 8018D700 26B550E8 */     addiu $s5, $s5, %lo(gMatchData)
  ...
  /* 16C3AC 8018D75C 8EAB0000 */        lw $t3, ($s5) # gMatchData + 0
  ...
  /* 16C3D8 8018D788 8EA20000 */        lw $v0, ($s5) # gMatchData + 0
...
glabel func_ovl41_8018DE88
  ...
  /* 16CAE8 8018DE98 3C02800A */       lui $v0, %hi(gMatchData)
  /* 16CAEC 8018DE9C 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 16CAF0 8018DEA0 244250E8 */     addiu $v0, $v0, %lo(gMatchData)
  ...
  /* 16CB3C 8018DEEC AC430000 */        sw $v1, ($v0) # gMatchData + 0
