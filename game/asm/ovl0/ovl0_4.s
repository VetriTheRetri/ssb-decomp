...
glabel func_ovl0_800D45A4
  ...
  /* 04FF8C 800D45AC 3C04800A */       lui $a0, %hi(Save_Info)
  /* 04FF90 800D45B0 0C035148 */       jal func_ovl0_800D4520
  /* 04FF94 800D45B4 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
  /* 04FF98 800D45B8 3C03800A */       lui $v1, %hi(Save_Info)
  /* 04FF9C 800D45BC 246344E0 */     addiu $v1, $v1, %lo(Save_Info)
  /* 04FFA0 800D45C0 8C6E05E8 */        lw $t6, 0x5e8($v1) # Save_Info + 1512
  ...
  /* 04FFB0 800D45D0 946F05E4 */       lhu $t7, 0x5e4($v1) # Save_Info + 1508
...
glabel func_ovl0_800D45F4
  ...
  /* 04FFDC 800D45FC 3C04800A */       lui $a0, %hi(Save_Info)
  /* 04FFE0 800D4600 0C035148 */       jal func_ovl0_800D4520
  /* 04FFE4 800D4604 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
  /* 04FFE8 800D4608 3C04800A */       lui $a0, %hi(Save_Info)
  /* 04FFEC 800D460C 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
  /* 04FFF0 800D4610 AC8205E8 */        sw $v0, 0x5e8($a0) # Save_Info + 1512
  ...
  /* 050000 800D4620 3C04800A */       lui $a0, %hi(Save_Info)
  /* 050004 800D4624 248444E0 */     addiu $a0, $a0, %lo(Save_Info)
...
glabel func_ovl0_800D4644
  ...
  /* 05002C 800D464C 3C05800A */       lui $a1, %hi(Save_Info)
  /* 050030 800D4650 24A544E0 */     addiu $a1, $a1, %lo(Save_Info)
  ...
  /* 050050 800D4670 3C05800A */       lui $a1, %hi(Save_Info)
  /* 050054 800D4674 24A544E0 */     addiu $a1, $a1, %lo(Save_Info)
  ...
  /* 05006C 800D468C 3C0E800A */       lui $t6, %hi(Save_Info)
  ...
  /* 05007C 800D469C 25CE44E0 */     addiu $t6, $t6, %lo(Save_Info)
  .L800D46A0:
...
glabel func_ovl0_800D46F4
  ...
  /* 0500DC 800D46FC 3C04800A */       lui $a0, %hi((Save_Info + 0x451))
  /* 0500E0 800D4700 0C00828D */       jal func_80020A34
  /* 0500E4 800D4704 90844931 */       lbu $a0, %lo((Save_Info + 0x451))($a0)
  /* 0500E8 800D4708 3C02800A */       lui $v0, %hi(Save_Info)
  /* 0500EC 800D470C 244244E0 */     addiu $v0, $v0, %lo(Save_Info)
  /* 0500F0 800D4710 84440452 */        lh $a0, 0x452($v0) # Save_Info + 1106
  /* 0500F4 800D4714 84460454 */        lh $a2, 0x454($v0) # Save_Info + 1108
...
glabel func_ovl0_800D473C
  /* 05011C 800D473C 3C03800A */       lui $v1, %hi(Save_Info)
  /* 050120 800D4740 246344E0 */     addiu $v1, $v1, %lo(Save_Info)
  /* 050124 800D4744 94620458 */       lhu $v0, 0x458($v1) # Save_Info + 1112
  /* 050128 800D4748 906E0456 */       lbu $t6, 0x456($v1) # Save_Info + 1110
  ...
  /* 050140 800D4760 3C04800A */       lui $a0, %hi(Scene_Info)
  /* 050144 800D4764 3C08800A */       lui $t0, %hi((D_800A3994 + 0x456))
  /* 050148 800D4768 91083DEA */       lbu $t0, %lo((D_800A3994 + 0x456))($t0)
  /* 05014C 800D476C A0680456 */        sb $t0, 0x456($v1) # Save_Info + 1110
  .L800D4770:
  /* 050150 800D4770 24844AD0 */     addiu $a0, $a0, %lo(Scene_Info)
  /* 050154 800D4774 90890014 */       lbu $t1, 0x14($a0) # Scene_Info + 20
  ...
  /* 050170 800D4790 A0850014 */        sb $a1, 0x14($a0) # Scene_Info + 20
  .L800D4794:
  /* 050174 800D4794 908D003B */       lbu $t5, 0x3b($a0) # Scene_Info + 59
  ...
  /* 050190 800D47B0 A085003B */        sb $a1, 0x3b($a0) # Scene_Info + 59
  .L800D47B4:
  /* 050194 800D47B4 9099003D */       lbu $t9, 0x3d($a0) # Scene_Info + 61
  ...
  /* 0501B0 800D47D0 A085003D */        sb $a1, 0x3d($a0) # Scene_Info + 61
  .L800D47D4:
  ...
  .L800D4874:
  /* 050254 800D4874 90620457 */       lbu $v0, 0x457($v1) # Save_Info + 1111
  ...
  /* 050264 800D4884 908C0041 */       lbu $t4, 0x41($a0) # Scene_Info + 65
  ...
  /* 05027C 800D489C A08F0041 */        sb $t7, 0x41($a0) # Scene_Info + 65
  .L800D48A0:
  /* 050280 800D48A0 908D0042 */       lbu $t5, 0x42($a0) # Scene_Info + 66
  ...
  /* 050290 800D48B0 A08E0042 */        sb $t6, 0x42($a0) # Scene_Info + 66
  .L800D48B4:
...
glabel func_ovl0_800D48E0
  /* 0502C0 800D48E0 3C02800A */       lui $v0, %hi(Save_Info)
  /* 0502C4 800D48E4 244244E0 */     addiu $v0, $v0, %lo(Save_Info)
  /* 0502C8 800D48E8 904E0457 */       lbu $t6, 0x457($v0) # Save_Info + 1111
  ...
  /* 0502E0 800D4900 A0580457 */        sb $t8, 0x457($v0) # Save_Info + 1111
  /* 0502E4 800D4904 03194025 */        or $t0, $t8, $t9
  /* 0502E8 800D4908 A0480457 */        sb $t0, 0x457($v0) # Save_Info + 1111
  /* 0502EC 800D490C 03E00008 */        jr $ra
  /* 0502F0 800D4910 A4490458 */        sh $t1, 0x458($v0) # Save_Info + 1112

glabel func_ovl0_800D4914
  /* 0502F4 800D4914 3C03800A */       lui $v1, %hi(Save_Info)
  ...
  /* 050308 800D4928 246344E0 */     addiu $v1, $v1, %lo(Save_Info)
  .L800D492C:
  ...
  /* 050334 800D4954 AC69047C */        sw $t1, 0x47c($v1) # Save_Info + 1148
  /* 050338 800D4958 AC6A0480 */        sw $t2, 0x480($v1) # Save_Info + 1152
  /* 05033C 800D495C AC6B0484 */        sw $t3, 0x484($v1) # Save_Info + 1156
  /* 050340 800D4960 A06C0488 */        sb $t4, 0x488($v1) # Save_Info + 1160
  /* 050344 800D4964 A06D0499 */        sb $t5, 0x499($v1) # Save_Info + 1177
  /* 050348 800D4968 AC6E045C */        sw $t6, 0x45c($v1) # Save_Info + 1116
  /* 05034C 800D496C AC6F0460 */        sw $t7, 0x460($v1) # Save_Info + 1120
  /* 050350 800D4970 AC780464 */        sw $t8, 0x464($v1) # Save_Info + 1124
  /* 050354 800D4974 A0790468 */        sb $t9, 0x468($v1) # Save_Info + 1128
  /* 050358 800D4978 A0680479 */        sb $t0, 0x479($v1) # Save_Info + 1145
  ...
  /* 05038C 800D49AC A0680439 */        sb $t0, 0x439($v1) # Save_Info + 1081
  /* 050390 800D49B0 A0790428 */        sb $t9, 0x428($v1) # Save_Info + 1064
  /* 050394 800D49B4 AC780424 */        sw $t8, 0x424($v1) # Save_Info + 1060
  /* 050398 800D49B8 AC6F0420 */        sw $t7, 0x420($v1) # Save_Info + 1056
  /* 05039C 800D49BC AC6E041C */        sw $t6, 0x41c($v1) # Save_Info + 1052
  /* 0503A0 800D49C0 A06D0459 */        sb $t5, 0x459($v1) # Save_Info + 1113
  /* 0503A4 800D49C4 A06C0448 */        sb $t4, 0x448($v1) # Save_Info + 1096
  /* 0503A8 800D49C8 AC6B0444 */        sw $t3, 0x444($v1) # Save_Info + 1092
  /* 0503AC 800D49CC AC6A0440 */        sw $t2, 0x440($v1) # Save_Info + 1088
  /* 0503B0 800D49D0 1482FFD6 */       bne $a0, $v0, .L800D492C
  /* 0503B4 800D49D4 AC69043C */        sw $t1, 0x43c($v1) # Save_Info + 1084
  /* 0503B8 800D49D8 03E00008 */        jr $ra
  /* 0503BC 800D49DC 00000000 */       nop 

glabel func_ovl0_800D49E0
  /* 0503C0 800D49E0 3C03800A */       lui $v1, %hi(Save_Info)
  /* 0503C4 800D49E4 3C04800A */       lui $a0, %hi(D_800A3994)
  /* 0503C8 800D49E8 3C05800A */       lui $a1, %hi((Save_Info + 0x5C))
  /* 0503CC 800D49EC 3C06800A */       lui $a2, %hi((D_800A3994 + 0x5c))
  /* 0503D0 800D49F0 3C07800A */       lui $a3, %hi((Save_Info + 0xB8))
  /* 0503D4 800D49F4 3C08800A */       lui $t0, %hi((D_800A3994 + 0xB8))
  /* 0503D8 800D49F8 3C09800A */       lui $t1, %hi((Save_Info + 0x114))
  ...
  /* 0503EC 800D4A0C 252945F4 */     addiu $t1, $t1, %lo((Save_Info + 0x114))
  /* 0503F0 800D4A10 25083A4C */     addiu $t0, $t0, %lo((D_800A3994 + 0xB8))
  /* 0503F4 800D4A14 24E74598 */     addiu $a3, $a3, %lo((Save_Info + 0xB8))
  /* 0503F8 800D4A18 24C639F0 */     addiu $a2, $a2, %lo((D_800A3994 + 0x5c))
  /* 0503FC 800D4A1C 24A5453C */     addiu $a1, $a1, %lo((Save_Info + 0x5C))
  /* 050400 800D4A20 24843994 */     addiu $a0, $a0, %lo(D_800A3994)
  /* 050404 800D4A24 246344E0 */     addiu $v1, $v1, %lo(Save_Info)
  .L800D4A28:
  ...
  /* 050534 800D4B54 3C01800A */       lui $at, %hi((Save_Info + 0x5e0))
  /* 050538 800D4B58 03E00008 */        jr $ra
  /* 05053C 800D4B5C A42E4AC0 */        sh $t6, %lo((Save_Info + 0x5e0))($at)

glabel func_ovl0_800D4B60
  /* 050540 800D4B60 3C03800A */       lui $v1, %hi(Save_Info)
  ...
  /* 050554 800D4B74 246344E0 */     addiu $v1, $v1, %lo(Save_Info)
  .L800D4B78:
  ...
  /* 050570 800D4B90 AC68048C */        sw $t0, 0x48c($v1) # Save_Info + 1164
  /* 050574 800D4B94 A0690490 */        sb $t1, 0x490($v1) # Save_Info + 1168
  /* 050578 800D4B98 AC6E046C */        sw $t6, 0x46c($v1) # Save_Info + 1132
  /* 05057C 800D4B9C A06F0470 */        sb $t7, 0x470($v1) # Save_Info + 1136
  /* 050580 800D4BA0 AC780474 */        sw $t8, 0x474($v1) # Save_Info + 1140
  /* 050584 800D4BA4 A0790478 */        sb $t9, 0x478($v1) # Save_Info + 1144
  ...
  /* 0505B8 800D4BD8 A0790450 */        sb $t9, 0x450($v1) # Save_Info + 1104
  /* 0505BC 800D4BDC AC78044C */        sw $t8, 0x44c($v1) # Save_Info + 1100
  /* 0505C0 800D4BE0 A06F0438 */        sb $t7, 0x438($v1) # Save_Info + 1080
  /* 0505C4 800D4BE4 AC6E0434 */        sw $t6, 0x434($v1) # Save_Info + 1076
  /* 0505C8 800D4BE8 A0690458 */        sb $t1, 0x458($v1) # Save_Info + 1112
  /* 0505CC 800D4BEC AC680454 */        sw $t0, 0x454($v1) # Save_Info + 1108
  /* 0505D0 800D4BF0 AC6A0414 */        sw $t2, 0x414($v1) # Save_Info + 1044
  /* 0505D4 800D4BF4 A06B0418 */        sb $t3, 0x418($v1) # Save_Info + 1048
  /* 0505D8 800D4BF8 AC6C042C */        sw $t4, 0x42c($v1) # Save_Info + 1068
  /* 0505DC 800D4BFC 1482FFDE */       bne $a0, $v0, .L800D4B78
  /* 0505E0 800D4C00 A06D0430 */        sb $t5, 0x430($v1) # Save_Info + 1072
  /* 0505E4 800D4C04 03E00008 */        jr $ra
  /* 0505E8 800D4C08 00000000 */       nop 

glabel func_ovl0_800D4C0C
  /* 0505EC 800D4C0C 3C02800A */       lui $v0, %hi(Save_Info)
  /* 0505F0 800D4C10 244244E0 */     addiu $v0, $v0, %lo(Save_Info)
  /* 0505F4 800D4C14 904E0457 */       lbu $t6, 0x457($v0) # Save_Info + 1111
  ...
  /* 050610 800D4C30 A0580457 */        sb $t8, 0x457($v0) # Save_Info + 1111
  /* 050614 800D4C34 03194025 */        or $t0, $t8, $t9
  /* 050618 800D4C38 A0480457 */        sb $t0, 0x457($v0) # Save_Info + 1111
  /* 05061C 800D4C3C A44905DC */        sh $t1, 0x5dc($v0) # Save_Info + 1500
  /* 050620 800D4C40 03E00008 */        jr $ra
  /* 050624 800D4C44 A04A05DE */        sb $t2, 0x5de($v0) # Save_Info + 1502

glabel func_ovl0_800D4C48
  /* 050628 800D4C48 3C0F800A */       lui $t7, %hi(D_800A3994)
  /* 05062C 800D4C4C 25EF3994 */     addiu $t7, $t7, %lo(D_800A3994)
  /* 050630 800D4C50 3C0E800A */       lui $t6, %hi(Save_Info)
  /* 050634 800D4C54 25CE44E0 */     addiu $t6, $t6, %lo(Save_Info)
