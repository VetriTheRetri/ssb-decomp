...
glabel func_ovl45_80131DB8
  ...
  /* 1700A8 80131E68 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl45_80131E84
  ...
  /* 1701AC 80131F6C 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl45_8013203C
  ...
  /* 1702F4 801320B4 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 1702F8 801320B8 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 1702FC 801320BC 90480000 */       lbu $t0, ($v0) # Scene_Info + 0
  /* 170300 801320C0 A0490000 */        sb $t1, ($v0) # Scene_Info + 0
  /* 170304 801320C4 0C00171D */       jal func_80005C74
  /* 170308 801320C8 A0480001 */        sb $t0, 1($v0) # Scene_Info + 1
  .L801320CC:
  /* 17030C 801320CC 3C0A8013 */       lui $t2, %hi(D_ovl45_80132438)
  /* 170310 801320D0 8D4A2438 */        lw $t2, %lo(D_ovl45_80132438)($t2)
  /* 170314 801320D4 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 170318 801320D8 240100A0 */     addiu $at, $zero, 0xa0
  /* 17031C 801320DC 15410006 */       bne $t2, $at, .L801320F8
  /* 170320 801320E0 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 170324 801320E4 904B0000 */       lbu $t3, ($v0) # Scene_Info + 0
  /* 170328 801320E8 240C002C */     addiu $t4, $zero, 0x2c
  /* 17032C 801320EC A04C0000 */        sb $t4, ($v0) # Scene_Info + 0
  /* 170330 801320F0 0C00171D */       jal func_80005C74
  /* 170334 801320F4 A04B0001 */        sb $t3, 1($v0) # Scene_Info + 1
  .L801320F8:
