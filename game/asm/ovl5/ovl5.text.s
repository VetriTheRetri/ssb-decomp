...
glabel func_ovl5_8018D1A0
  ...
  /* 10B460 8018D1B0 3C02800A */       lui $v0, %hi(gMatchData)
  /* 10B464 8018D1B4 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 10B468 8018D1B8 244250E8 */     addiu $v0, $v0, %lo(gMatchData)
  ...
  /* 10B4DC 8018D22C AC430000 */        sw $v1, ($v0) # gMatchData + 0
  ...
  /* 10B614 8018D364 3C0C800A */       lui $t4, %hi(gMatchData)
  /* 10B618 8018D368 00114080 */       sll $t0, $s1, 2
  /* 10B61C 8018D36C AD580000 */        sw $t8, ($t2)
  /* 10B620 8018D370 8D8C50E8 */        lw $t4, %lo(gMatchData)($t4)
  ...
  /* 10B64C 8018D39C 3C02800A */       lui $v0, %hi(gMatchData)
  /* 10B650 8018D3A0 8C4250E8 */        lw $v0, %lo(gMatchData)($v0)
