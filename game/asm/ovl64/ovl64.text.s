...
glabel func_ovl64_8018D0E0
  ...
  .L8018D110:
  /* 18BE50 8018D110 3C0F800A */       lui $t7, %hi(gMatchData)
  /* 18BE54 8018D114 8DEF50E8 */        lw $t7, %lo(gMatchData)($t7)
...
glabel func_ovl64_8018D2CC
  /* 18C00C 8018D2CC 3C05800A */       lui $a1, %hi(gMatchData)
  /* 18C010 8018D2D0 24A550E8 */     addiu $a1, $a1, %lo(gMatchData)
  /* 18C014 8018D2D4 8CAE0000 */        lw $t6, ($a1) # gMatchData + 0
  ...
  /* 18C034 8018D2F4 3C05800A */       lui $a1, %hi(gMatchData)
  /* 18C038 8018D2F8 10400004 */      beqz $v0, .L8018D30C
  /* 18C03C 8018D2FC 24A550E8 */     addiu $a1, $a1, %lo(gMatchData)
  ...
  .L8018D30C:
  /* 18C04C 8018D30C 8CB80000 */        lw $t8, ($a1) # gMatchData + 0
  ...
  /* 18C060 8018D320 8CA20000 */        lw $v0, ($a1) # gMatchData + 0
  ...
  /* 18C07C 8018D33C 8CAD0000 */        lw $t5, ($a1) # gMatchData + 0
  ...
  /* 18C0DC 8018D39C 3C0E800A */       lui $t6, %hi(gMatchData)
  /* 18C0E0 8018D3A0 8DCE50E8 */        lw $t6, %lo(gMatchData)($t6)
  ...
  /* 18C114 8018D3D4 3C06800A */       lui $a2, %hi(gMatchData)
  /* 18C118 8018D3D8 24C650E8 */     addiu $a2, $a2, %lo(gMatchData)
  /* 18C11C 8018D3DC 8CC20000 */        lw $v0, ($a2) # gMatchData + 0
  ...
  /* 18C178 8018D438 3C06800A */       lui $a2, %hi(gMatchData)
  /* 18C17C 8018D43C 10400004 */      beqz $v0, .L8018D450
  /* 18C180 8018D440 24C650E8 */     addiu $a2, $a2, %lo(gMatchData)
  ...
  .L8018D450:
  /* 18C190 8018D450 8CCC0000 */        lw $t4, ($a2) # gMatchData + 0
  ...
  /* 18C1D4 8018D494 8CCE0000 */        lw $t6, ($a2) # gMatchData + 0
  ...
  /* 18C230 8018D4F0 3C0E800A */       lui $t6, %hi(gMatchData)
  /* 18C234 8018D4F4 8DCE50E8 */        lw $t6, %lo(gMatchData)($t6)
  ...
  /* 18C268 8018D528 3C06800A */       lui $a2, %hi(gMatchData)
  /* 18C26C 8018D52C 24C650E8 */     addiu $a2, $a2, %lo(gMatchData)
  /* 18C270 8018D530 8CCE0000 */        lw $t6, ($a2) # gMatchData + 0
  ...
  /* 18C288 8018D548 3C06800A */       lui $a2, %hi(gMatchData)
  /* 18C28C 8018D54C 24C650E8 */     addiu $a2, $a2, %lo(gMatchData)
  /* 18C290 8018D550 8CD90000 */        lw $t9, ($a2) # gMatchData + 0
  ...
  /* 18C2AC 8018D56C 8CC30000 */        lw $v1, ($a2) # gMatchData + 0
  ...
  /* 18C2D0 8018D590 8CCF0000 */        lw $t7, ($a2) # gMatchData + 0
...
glabel func_ovl64_8018D990
  ...
  /* 18C6E4 8018D9A4 3C12800A */       lui $s2, %hi(gMatchData)
  ...
  /* 18C6F4 8018D9B4 265250E8 */     addiu $s2, $s2, %lo(gMatchData)
  ...
  /* 18C750 8018DA10 AE430000 */        sw $v1, ($s2) # gMatchData + 0
  ...
  .L8018DA6C:
  /* 18C7AC 8018DA6C 8E4D0000 */        lw $t5, ($s2) # gMatchData + 0
  ...
  /* 18C7E0 8018DAA0 8E490000 */        lw $t1, ($s2) # gMatchData + 0
  ...
  /* 18C7FC 8018DABC 8E4B0000 */        lw $t3, ($s2) # gMatchData + 0
  ...
  /* 18C80C 8018DACC 8E4D0000 */        lw $t5, ($s2) # gMatchData + 0
...
glabel func_ovl64_8018DB18
  ...
  /* 18C910 8018DBD0 3C15800A */       lui $s5, %hi(gMatchData)
  ...
  /* 18C920 8018DBE0 26B550E8 */     addiu $s5, $s5, %lo(gMatchData)
  ...
  .L8018DBF4:
  /* 18C934 8018DBF4 8EAF0000 */        lw $t7, ($s5) # gMatchData + 0
...
glabel func_ovl64_8018DCC4
  ...
  /* 18CAD4 8018DD94 3C12800A */       lui $s2, %hi(gMatchData)
  /* 18CAD8 8018DD98 265250E8 */     addiu $s2, $s2, %lo(gMatchData)
  ...
  /* 18CB28 8018DDE8 8E4A0000 */        lw $t2, ($s2) # gMatchData + 0
  ...
  /* 18CB38 8018DDF8 8E4C0000 */        lw $t4, ($s2) # gMatchData + 0
  ...
  .L8018DE44:
  /* 18CB84 8018DE44 8E430000 */        lw $v1, ($s2) # gMatchData + 0
  ...
  /* 18CC18 8018DED8 8E4D0000 */        lw $t5, ($s2) # gMatchData + 0
  ...
  /* 18CC2C 8018DEEC 8E490000 */        lw $t1, ($s2) # gMatchData + 0
