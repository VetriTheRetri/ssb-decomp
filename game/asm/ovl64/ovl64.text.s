...
glabel func_ovl64_8018D0E0
  ...
  .L8018D110:
  /* 18BE50 8018D110 3C0F800A */       lui $t7, %hi(Match_Info)
  /* 18BE54 8018D114 8DEF50E8 */        lw $t7, %lo(Match_Info)($t7)
...
glabel func_ovl64_8018D134
  ...
  /* 18BEA0 8018D160 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 18BEA4 8018D164 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 18BEA8 8018D168 904F0000 */       lbu $t7, ($v0) # Scene_Info + 0
  /* 18BEAC 8018D16C 24180001 */     addiu $t8, $zero, 1
  /* 18BEB0 8018D170 A0580000 */        sb $t8, ($v0) # Scene_Info + 0
  /* 18BEB4 8018D174 0C00171D */       jal func_80005C74
  /* 18BEB8 8018D178 A04F0001 */        sb $t7, 1($v0) # Scene_Info + 1
...
glabel func_ovl64_8018D2CC
  /* 18C00C 8018D2CC 3C05800A */       lui $a1, %hi(Match_Info)
  /* 18C010 8018D2D0 24A550E8 */     addiu $a1, $a1, %lo(Match_Info)
  /* 18C014 8018D2D4 8CAE0000 */        lw $t6, ($a1) # Match_Info + 0
  ...
  /* 18C034 8018D2F4 3C05800A */       lui $a1, %hi(Match_Info)
  /* 18C038 8018D2F8 10400004 */      beqz $v0, .L8018D30C
  /* 18C03C 8018D2FC 24A550E8 */     addiu $a1, $a1, %lo(Match_Info)
  ...
  .L8018D30C:
  /* 18C04C 8018D30C 8CB80000 */        lw $t8, ($a1) # Match_Info + 0
  ...
  /* 18C060 8018D320 8CA20000 */        lw $v0, ($a1) # Match_Info + 0
  ...
  /* 18C07C 8018D33C 8CAD0000 */        lw $t5, ($a1) # Match_Info + 0
  ...
  /* 18C0DC 8018D39C 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 18C0E0 8018D3A0 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
  ...
  /* 18C114 8018D3D4 3C06800A */       lui $a2, %hi(Match_Info)
  /* 18C118 8018D3D8 24C650E8 */     addiu $a2, $a2, %lo(Match_Info)
  /* 18C11C 8018D3DC 8CC20000 */        lw $v0, ($a2) # Match_Info + 0
  ...
  /* 18C178 8018D438 3C06800A */       lui $a2, %hi(Match_Info)
  /* 18C17C 8018D43C 10400004 */      beqz $v0, .L8018D450
  /* 18C180 8018D440 24C650E8 */     addiu $a2, $a2, %lo(Match_Info)
  ...
  .L8018D450:
  /* 18C190 8018D450 8CCC0000 */        lw $t4, ($a2) # Match_Info + 0
  ...
  /* 18C1D4 8018D494 8CCE0000 */        lw $t6, ($a2) # Match_Info + 0
  ...
  /* 18C230 8018D4F0 3C0E800A */       lui $t6, %hi(Match_Info)
  /* 18C234 8018D4F4 8DCE50E8 */        lw $t6, %lo(Match_Info)($t6)
  ...
  /* 18C268 8018D528 3C06800A */       lui $a2, %hi(Match_Info)
  /* 18C26C 8018D52C 24C650E8 */     addiu $a2, $a2, %lo(Match_Info)
  /* 18C270 8018D530 8CCE0000 */        lw $t6, ($a2) # Match_Info + 0
  ...
  /* 18C288 8018D548 3C06800A */       lui $a2, %hi(Match_Info)
  /* 18C28C 8018D54C 24C650E8 */     addiu $a2, $a2, %lo(Match_Info)
  /* 18C290 8018D550 8CD90000 */        lw $t9, ($a2) # Match_Info + 0
  ...
  /* 18C2AC 8018D56C 8CC30000 */        lw $v1, ($a2) # Match_Info + 0
...
glabel func_ovl64_8018D5F0
  /* 18C330 8018D5F0 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 18C334 8018D5F4 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 18C338 8018D5F8 904E0000 */       lbu $t6, ($v0) # Scene_Info + 0
  ...
  /* 18C348 8018D608 A04F0000 */        sb $t7, ($v0) # Scene_Info + 0
  /* 18C34C 8018D60C 0C00171D */       jal func_80005C74
  /* 18C350 8018D610 A04E0001 */        sb $t6, 1($v0) # Scene_Info + 1
...
glabel func_ovl64_8018D8C0
  ...
  /* 18C610 8018D8D0 3C02800A */       lui $v0, %hi((Scene_Info + 0xD))
  /* 18C614 8018D8D4 00441021 */      addu $v0, $v0, $a0
  /* 18C618 8018D8D8 1000001A */         b .L8018D944
  /* 18C61C 8018D8DC 90424ADD */       lbu $v0, %lo((Scene_Info + 0xD))($v0)
  .L8018D8E0:
  /* 18C620 8018D8E0 3C04800A */       lui $a0, %hi((Save_Info + 0x458))
  /* 18C624 8018D8E4 94844938 */       lhu $a0, %lo((Save_Info + 0x458))($a0)
...
glabel func_ovl64_8018D990
  ...
  /* 18C6E4 8018D9A4 3C12800A */       lui $s2, %hi(Match_Info)
  /* 18C6E8 8018D9A8 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 18C6EC 8018D9AC 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 18C6F0 8018D9B0 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 18C6F4 8018D9B4 265250E8 */     addiu $s2, $s2, %lo(Match_Info)
  ...
  /* 18C748 8018DA08 904A0040 */       lbu $t2, 0x40($v0) # Scene_Info + 64
  /* 18C74C 8018DA0C 904D0040 */       lbu $t5, 0x40($v0) # Scene_Info + 64
  /* 18C750 8018DA10 AE430000 */        sw $v1, ($s2) # Match_Info + 0
  ...
  /* 18C76C 8018DA2C A0480040 */        sb $t0, 0x40($v0) # Scene_Info + 64
  /* 18C770 8018DA30 14200002 */      bnez $at, .L8018DA3C
  /* 18C774 8018DA34 A06B0001 */        sb $t3, 1($v1) # D_ovl64_8018E2F0 + 1
  /* 18C778 8018DA38 A0400040 */        sb $zero, 0x40($v0) # Scene_Info + 64
  .L8018DA3C:
  /* 18C77C 8018DA3C 9059000E */       lbu $t9, 0xe($v0) # Scene_Info + 14
  /* 18C780 8018DA40 9049000D */       lbu $t1, 0xd($v0) # Scene_Info + 13
  ...
  .L8018DA6C:
  /* 18C7AC 8018DA6C 8E4D0000 */        lw $t5, ($s2) # Match_Info + 0
  ...
  /* 18C7E0 8018DAA0 8E490000 */        lw $t1, ($s2) # Match_Info + 0
  ...
  /* 18C7FC 8018DABC 8E4B0000 */        lw $t3, ($s2) # Match_Info + 0
  ...
  /* 18C80C 8018DACC 8E4D0000 */        lw $t5, ($s2) # Match_Info + 0
...
glabel func_ovl64_8018DB18
  ...
  /* 18C910 8018DBD0 3C15800A */       lui $s5, %hi(Match_Info)
  ...
  /* 18C920 8018DBE0 26B550E8 */     addiu $s5, $s5, %lo(Match_Info)
  ...
  .L8018DBF4:
  /* 18C934 8018DBF4 8EAF0000 */        lw $t7, ($s5) # Match_Info + 0
...
glabel func_ovl64_8018DCC4
  ...
  /* 18CAD4 8018DD94 3C12800A */       lui $s2, %hi(Match_Info)
  /* 18CAD8 8018DD98 265250E8 */     addiu $s2, $s2, %lo(Match_Info)
  ...
  /* 18CB28 8018DDE8 8E4A0000 */        lw $t2, ($s2) # Match_Info + 0
  ...
  /* 18CB38 8018DDF8 8E4C0000 */        lw $t4, ($s2) # Match_Info + 0
  ...
  .L8018DE44:
  /* 18CB84 8018DE44 8E430000 */        lw $v1, ($s2) # Match_Info + 0
