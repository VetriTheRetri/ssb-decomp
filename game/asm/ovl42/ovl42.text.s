...
glabel func_ovl42_8018D42C
  ...
  /* 16D2F0 8018D540 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl42_8018D634
  ...
  /* 16D49C 8018D6EC 3C15800A */       lui $s5, %hi(Match_Info)
  /* 16D4A0 8018D6F0 26B550E8 */     addiu $s5, $s5, %lo(Match_Info)
  ...
  /* 16D4FC 8018D74C 8EAB0000 */        lw $t3, ($s5) # Match_Info + 0
  ...
  /* 16D528 8018D778 8EA20000 */        lw $v0, ($s5) # Match_Info + 0
...
glabel func_ovl42_8018DA80
  ...
  /* 16D8F4 8018DB44 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl42_8018DC20
  ...
  /* 16DAA8 8018DCF8 0C002062 */       jal gOMObj_AddGObjCommonProc
...
glabel func_ovl42_8018DDC0
  ...
  /* 16DBA0 8018DDF0 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 16DBA4 8018DDF4 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 16DBA8 8018DDF8 90580000 */       lbu $t8, ($v0) # Scene_Info + 0
  /* 16DBAC 8018DDFC A0590000 */        sb $t9, ($v0) # Scene_Info + 0
  /* 16DBB0 8018DE00 0C00171D */       jal func_80005C74
  /* 16DBB4 8018DE04 A0580001 */        sb $t8, 1($v0) # Scene_Info + 1
  .L8018DE08:
  ...
  /* 16DBD0 8018DE20 0C0026A1 */       jal gOMObj_EjectGObjCommon
  ...
  /* 16DC04 8018DE54 3C02800A */       lui $v0, %hi(Scene_Info)
  /* 16DC08 8018DE58 24424AD0 */     addiu $v0, $v0, %lo(Scene_Info)
  /* 16DC0C 8018DE5C 90480000 */       lbu $t0, ($v0) # Scene_Info + 0
  /* 16DC10 8018DE60 A0490000 */        sb $t1, ($v0) # Scene_Info + 0
  /* 16DC14 8018DE64 0C00171D */       jal func_80005C74
  /* 16DC18 8018DE68 A0480001 */        sb $t0, 1($v0) # Scene_Info + 1
  .L8018DE6C:
...
glabel func_ovl42_8018DE88
  ...
  /* 16DC48 8018DE98 3C02800A */       lui $v0, %hi(Match_Info)
  /* 16DC4C 8018DE9C 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 16DC50 8018DEA0 244250E8 */     addiu $v0, $v0, %lo(Match_Info)
  ...
  /* 16DC9C 8018DEEC AC430000 */        sw $v1, ($v0) # Match_Info + 0
