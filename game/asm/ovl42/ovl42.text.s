...
glabel func_ovl42_8018D634
  ...
  /* 16D49C 8018D6EC 3C15800A */       lui $s5, %hi(gpMatchData)
  /* 16D4A0 8018D6F0 26B550E8 */     addiu $s5, $s5, %lo(gpMatchData)
  ...
  /* 16D4FC 8018D74C 8EAB0000 */        lw $t3, ($s5) # gpMatchData + 0
  ...
  /* 16D528 8018D778 8EA20000 */        lw $v0, ($s5) # gpMatchData + 0
...
glabel func_ovl42_8018DE88
  ...
  /* 16DC48 8018DE98 3C02800A */       lui $v0, %hi(gpMatchData)
  /* 16DC4C 8018DE9C 25CE3FC8 */     addiu $t6, $t6, %lo(gDefaultBattleSettings)
  /* 16DC50 8018DEA0 244250E8 */     addiu $v0, $v0, %lo(gpMatchData)
  ...
  /* 16DC9C 8018DEEC AC430000 */        sw $v1, ($v0) # gpMatchData + 0
